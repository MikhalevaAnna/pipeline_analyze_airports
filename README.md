...
+---------+--------------------+--------------------+--------+---------+
```
Количество записей в датафрейме airports всего: 49.<br>
...
Количество записей на одну меньше, потому что в поле **DESTINATION_AIRPORT** указано некорректное значение = 10666. <br>
Оно не соответствует ни одному обозначению аэропорта.Запись некорректная, поэтому исключается из датафрейма. <br>
